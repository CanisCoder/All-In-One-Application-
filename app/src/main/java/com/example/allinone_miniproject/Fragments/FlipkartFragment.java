...
public class FlipkartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragmentreturn inflater.inflate(R.layout.fragment_flipkart, container, false);
        View view = inflater.inflate(R.layout.fragment_flipkart, container, false);
        WebView webView = view.findViewById(R.id.webView_flipkart);
